...
psql -U test -d intro_telecom -a -f ${exec_dir}/intro_telecom_02_tables.sql
psql -U test -d intro_telecom -a -f ${exec_dir}/intro_telecom_03_tables_initial_population.sql
