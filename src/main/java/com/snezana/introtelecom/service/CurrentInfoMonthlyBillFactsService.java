...
import static com.snezana.introtelecom.service.FramesSDRService.*;

@Service
@Transactional
@RequiredArgsConstructor
public class CurrentInfoMonthlyBillFactsService{
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(CurrentInfoMonthlyBillFactsService.class);
