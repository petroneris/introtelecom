...
public class UserPhoneController {
    ...
    @Operation(tags = "UserPhone Controller", summary = "update a package code", description = "update a package code")
    @SecurityRequirement(name = "Bearer Authentication")
    ...
    public ResponseEntity<RestAPIResponse<Map<String, String>>> changePackageCode(@PathVariable String phoneNumber, @RequestParam String packageCode){
        log.info(" updatePackageCode");
        log.info("phoneNumber is: {}", phoneNumber);
        log.info("packageCode is: {}", packageCode);
        usersPhonesService.changePackageCode(phoneNumber, packageCode);
        String message = "The package code is changed.";
        return ResponseEntity.ok(RestAPIResponse.of(RestMessage.view(message)));
    }

    @Operation(tags = "UserPhone Controller", summary = "change a phone status", description = "change a phone status")
    @SecurityRequirement(name = "Bearer Authentication")
    ...
    @Operation(tags = "UserPhone Controller", summary = "Get phone", description = "Get phone")
    @SecurityRequirement(name = "Bearer Authentication")
    ...
    @Operation(tags = "UserPhone Controller", summary = "Get phones by package code", description = "Get phones by package code")
    @SecurityRequirement(name = "Bearer Authentication")
    ...
    @Operation(tags = "UserPhone Controller", summary = "Get all admin phones", description = "Get all admin phones")
    @SecurityRequirement(name = "Bearer Authentication")
    ...
    @Operation(tags = "UserPhone Controller", summary = "Get all customers phones", description = "Get all customers phones")
    @SecurityRequirement(name = "Bearer Authentication")
    ...
    @Operation(tags = "UserPhone Controller", summary = "save a new user", description = "save a new user")
    @SecurityRequirement(name = "Bearer Authentication")
    ...
    @Operation(tags = "UserPhone Controller", summary = "Get user by phoneNumber", description = "Get user by phoneNumber")
    @SecurityRequirement(name = "Bearer Authentication")
    ...
    @Operation(tags = "UserPhone Controller", summary = "Get user by username", description = "Get user by username")
    @SecurityRequirement(name = "Bearer Authentication")
    ...
    @Operation(tags = "UserPhone Controller", summary = "Get all customers users")
    @SecurityRequirement(name = "Bearer Authentication")
